...
class TaskRepository {
  ...
  Future<void> updateTask(String taskId, {String? title, String? description,String? color, bool? isDone,bool? isImportant, DateTime? date,}) async {
    try {
  ...
  TaskModel createTask({String title = "", String description = "",String color ="" ,bool isImportant = false, bool isDone = false, required DateTime date}) {
    return TaskModel(
